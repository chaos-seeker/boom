...
export const HeroSlider = (props: HeroSliderProps) => {
  return (
    <section className="relative w-full aspect-27/8 container group">
      ...
      <div className="hero-slider-prev hidden lg:block absolute left-9 top-1/2 -translate-y-1/2 z-10 cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <div className="hero-slider-next hidden lg:block absolute right-9 top-1/2 -translate-y-1/2 z-10 cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <div className="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full text-white hover:bg-white/30 transition-colors duration-300">
